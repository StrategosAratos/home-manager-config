do
  ...
  do
    ...
    --#region We need to magic the lua lsp here
    local M = {
      runtime = {
      ...
      workspace = {
        ...
        -- library = library
        library = filter_inplace(vim.api.nvim_get_runtime_file('', true), is_package_path)
    ...
    if jit then
      local globals = M.diagnostics.globals
      globals[#globals + 1] = 'jit'
    end

    lsps["lua_ls"] = { settings = { Lua = M } }
    --#endregion
